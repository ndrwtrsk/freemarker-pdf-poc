...
<script>
    ...
    function drawChart() {
        ...
        injectedData.forEach(function(val, i){
            data.addRow(['Mushrooms' + i, val]);
        });
    ...
    function drawTable() {
        ...
        injectedData.forEach(function(val, i){
            data.addRow(['Mike' + i, {v: val, f: val + ''}, true]);
        });
    ...
    function drawVisualization() {
        ...
        injectedData.forEach(function(val, i){
            data.addRow(['2016/12', val, val, val, val, val, val]);
        });
    ...
    function drawSteppedChart() {
        ...
        injectedData.forEach(function(val, i){
            data.addRow(['Alfred Hitchcock (1935)' + i, val, val]);
        });
